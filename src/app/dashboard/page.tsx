...
// Data
const PRESENCE_DATA = [
  { name: "Présence", value: 81 },
  { name: "Retard", value: 22 },
  { name: "Absents", value: 62 },
];
...
const StatCard = ({ label, value, trend, trendColor, icon }: StatCardProps) => {
  ...
  // Associe une petite icône personnalisée à chaque statistique (exemple)
    ...
    <Card>
      <CardContent className="px-2 sm:px-4 py-6 sm:py-8 lg:py-10 flex flex-col sm:flex-row gap-3 sm:gap-4 items-center">
        ...
        <div className="text-center sm:text-left">
          ...
          >
            {/* Petite icône personnalisée à gauche du trend */}
            <Image
